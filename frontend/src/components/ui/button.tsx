...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-accent text-text-primary shadow hover:bg-accent-muted',
        destructive: 'bg-critical text-text-primary shadow-sm hover:bg-critical-muted',
        outline: 'border border-border bg-transparent shadow-sm hover:bg-surface hover:text-text-primary',
        secondary: 'bg-surface text-text-primary shadow-sm hover:bg-surface-elevated',
